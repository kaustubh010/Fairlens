      ...
      <main className="flex-1 flex items-center justify-center py-20 px-4">
        <div className="w-full max-w-md bg-white dark:bg-[#1d1d1f] rounded-2xl shadow-[0_5px_30px_rgba(0,0,0,0.12)] p-10 text-center">
          ...
          <form onSubmit={handleSignUp} className="space-y-4 text-left">
            <div>
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="w-full bg-[#f5f5f7] dark:bg-[#272729] border-t-[#1d1d1f]/10 dark:border-t-white/10 border-x-transparent border-b-transparent rounded-b-xl px-4 py-3 text-[#1d1d1f] dark:text-white focus:outline-none focus:ring-1 focus:ring-[#0071e3] focus:border-[#0071e3] focus:z-10 relative transition-all"
            ...
            <div>
              <label className="block text-sm font-medium text-[#1d1d1f]/80 dark:text-white/80 mb-2 mt-4">
                Email Address
              </label>
              <input
                type="email"
