        ...
        <div className="flex h-12 items-center justify-between px-4 lg:px-8 max-w-[1024px] mx-auto">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <Link href="/behavioral-dashboard" className="text-[12px] text-white/80 hover:text-white transition-colors">
                Dashboard
              </Link>
              <Link href="/behavioral" className="text-[12px] text-white/80 hover:text-white transition-colors">
                Run Audit
              </Link>
              <Link href="/prompts" className="text-[12px] text-white/80 hover:text-white transition-colors">
                Prompts
              </Link>
              <Link href="/methodology" className="text-[12px] text-white/80 hover:text-white transition-colors">
                Methodology
              </Link>
            </nav>
          </div>
